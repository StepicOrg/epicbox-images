...
* [`stepik/epicbox-base:trixie`](https://hub.docker.com/r/stepik/epicbox-base/)
...
* C++20: [`stepik/epicbox-gcc:12.2.0`](https://hub.docker.com/r/stepik/epicbox-gcc/)
* C++23: [`stepik/epicbox-gcc:14.2.0`](https://hub.docker.com/r/stepik/epicbox-gcc/)
...
* Go: [`stepik/epicbox-go:1.26.1-1`](https://hub.docker.com/r/stepik/epicbox-go/)
...
* Lua: [`stepik/epicbox-lua:5.4.7`](https://hub.docker.com/r/stepik/epicbox-lua/)
